'use client';
import { $getSelection, COMMAND_PRIORITY_CRITICAL, COMMAND_PRIORITY_LOW, KEY_ESCAPE_COMMAND } from '@payloadcms/richtext-lexical/lexical';
 ...
 */ export function useCommentCommands(editor, setShowCommentInput, setShowComments, showComments, showCommentInput, setActiveAnchorKey) {
    ...
    // Register commands
    useEffect(()=>{
        return editor.registerCommand(INSERT_COMMENT_COMMAND, ()=>{
    ...
    useEffect(()=>{
        return editor.registerCommand(TOGGLE_COMMENTS_COMMAND, ()=>{
...
//# sourceMappingURL=useCommentCommands.js.map