 ...
 */ export const CommentPlugin = ({ currentUser, documentId = 'default', userCollectionSlug })=>{
    // Editor context
    const [editor] = useLexicalComposerContext();
    // Comment store
    const commentStore = useMemo(()=>new CommentStore(editor, userCollectionSlug), [
        editor,
        userCollectionSlug
    ]);
    ...
    const { deleteAllComments, deleteCommentOrThread, resolveThread, submitAddComment } = useCommentOperations(commentStore, editor, markNodeMap, saveDocument);
    const { cancelAddComment, onAddComment, toggleComments } = useCommentCommands(editor, setShowCommentInput, setShowComments, showComments, showCommentInput, setActiveAnchorKey);
    ...
    useEffect(()=>{
        const updateResolvedClass = (threadId, resolved)=>{
            markNodeMap.get(threadId)?.forEach((key)=>{
                const elem = editor.getElementByKey(key);
                elem?.classList.toggle('resolved', resolved);
            });
        };
        comments.filter((c)=>c.type === 'thread').forEach((thread)=>updateResolvedClass(thread.id, thread.resolved ?? false));
    }, [
        comments,
        editor,
        markNodeMap
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            isDocumentSaved && showCommentInput && /*#__PURE__*/ createPortal(/*#__PURE__*/ _jsx(CommentInputBox, {
                author: currentUser,
            ...
            isDocumentSaved && activeAnchorKey !== null && !showCommentInput && /*#__PURE__*/ createPortal(/*#__PURE__*/ _jsx(AddCommentBox, {
                anchorKey: activeAnchorKey,
                editor: editor,
                onAddComment: onAddComment
            }), document.body),
            isDocumentSaved && /*#__PURE__*/ createPortal(/*#__PURE__*/ _jsx("button", {
            ...
            isDocumentSaved && showComments && /*#__PURE__*/ createPortal(/*#__PURE__*/ _jsx(CommentsPanel, {
                activeIDs: activeIDs,
                comments: comments,
